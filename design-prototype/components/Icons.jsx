...
const icon = (d, stroke = 1.8, fill = 'none') => ({ size = 20, style = {}, ...rest }) => (
...
const Icons = {
  ...
  Cmd: icon(<><path d="M9 6h6v12H9z" /><path d="M6 6V3H3v6h12v6h6v-6h-3" /><path d="M9 15v3H3v-6" /></>, 1.6),
  ...
  Translate: icon(<><path d="M4 5h7" /><path d="M9 3v2c0 4-2 6-5 8" /><path d="M5 9c0 3 4 5 7 5" /><path d="m13 20 5-11 5 11" /><path d="M15 16h6" /></>),
  Home: icon(<><path d="M3 12 12 4l9 8" /><path d="M5 10v10h14V10" /></>),
  ...
  Globe: icon(<><circle cx="12" cy="12" r="9" /><path d="M3 12h18" /><path d="M12 3a14 14 0 0 1 0 18" /><path d="M12 3a14 14 0 0 0 0 18" /></>),
};
